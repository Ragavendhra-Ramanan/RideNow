...
import 'package:riders_app/AllScreen/loginScreen.dart';
import 'package:riders_app/AllScreen/searchScreen.dart';
import 'package:riders_app/AllWidgets/divideWidget.dart';
...
import 'package:riders_app/Models/directionDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: [
         ...
         children: [
           Text("Hi", style: TextStyle(fontSize: 16.0, fontFamily: "Brand Bold"),),
           SizedBox(height: 6.0,),
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ((tripDirectionDetails != null) ? tripDirectionDetails!.distanceValue.toString() : '') , style: TextStyle(fontSize: 16.0, color: Colors.grey,),
                                    ),
                                  ],
                                ),
      ...
      if (map != null) {
        ...
        switch (callBack) {
          case Geofire.onKeyEntered:
            NearbyAvailableDrivers nearbyAvailableDrivers = NearbyAvailableDrivers(key: '', longitude: 0, latitude:0,);
